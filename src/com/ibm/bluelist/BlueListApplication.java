...
public final class BlueListApplication extends Application {
	...
	public static BlueListApplication myInstance;
	...
	public void onCreate() {
		...
		//this.connectToServer(props.getProperty(APP_ID),props.getProperty(APP_SECRET),props.getProperty(APP_ROUTE));
			
	}

	public static BlueListApplication getAppInstance(){
		return myInstance;
	}

	public void connectToServer( String key, String password,String route){

		// Initialize the IBM core backend-as-a-service.
		IBMBluemix.initialize(this, key, password, route);
